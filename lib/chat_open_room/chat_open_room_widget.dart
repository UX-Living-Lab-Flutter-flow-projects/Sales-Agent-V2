...
import 'chat_open_room_model.dart';
export 'chat_open_room_model.dart';

class ChatOpenRoomWidget extends StatefulWidget {
  const ChatOpenRoomWidget({
    Key? key,
  ...
  @override
  _ChatOpenRoomWidgetState createState() => _ChatOpenRoomWidgetState();
}

class _ChatOpenRoomWidgetState extends State<ChatOpenRoomWidget>
    with TickerProviderStateMixin {
  late ChatOpenRoomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatOpenRoomModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(2.0, 6.0, 2.0, 7.0),
                        child: Card(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.sendmsginputFocusNode,
                                            onFieldSubmitted: (_) async {
                                              await _model.listViewChat
                                                  ?.animateTo(
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (FFAppState().imagePicked) {
                                                ...
                                                _model.apiSendImageOpen =
                                                    await NewSendmessageToDatabaseCall
                                                        .call(
                                                  messageType:
                                                      FFAppState().image,
                                                  author: widget.portfolio,
                                                  side: 'false',
                                                  messageData: FFAppState()
                                                      .imagePickedFile,
                                                  roomId: widget.sessionID,
                                                  type: 'create_message',
                                                );
                                                _shouldSetState = true;
                                                if ((_model.apiSendImageOpen
                                                        ?.succeeded ??
                                                    true)) {
                                                  setState(() {
                                                    _model
                                                        .sendmsginputController
                                                        ?.clear();
                                                  });
                                                  setState(() => _model
                                                          .apiRequestCompleter =
