...
import 'chat_open_room_widget.dart' show ChatOpenRoomWidget;
import 'dart:async';
...
class ChatOpenRoomModel extends FlutterFlowModel<ChatOpenRoomWidget> {
  ...
  // Stores action output result for [Backend Call - API (new sendmessage to database)] action in IconButton widget.
  ApiCallResponse? apiSendImageOpen;
  // Stores action output result for [Backend Call - API (new sendmessage to database)] action in IconButton widget.
  ApiCallResponse? apiSendTextMessageOpen;
